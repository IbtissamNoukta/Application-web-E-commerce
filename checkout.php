...
<head>
    ...
    <!-- Title  -->
    <title>Ibtissam - MEUBLES | Checkout</title>
                ...
                <div class="row">
                    <div class="col-12 col-lg-8">
                        <div class="checkout_details_area mt-50 clearfix">
                            ...
                            <form action="AddCmd.php" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <input type="Number" class="form-control" id="phone_number" name="phone_number" min="0" placeholder="Phone No" value="">
                                    </div>
                                    <div class="col-12 mb-3">
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="cart-summary">
                            ...
                            <ul class="summary-table">
                                <li><span>total:</span> <span>$<?php $S=$_SESSION['S']; echo $S;?></span></li>
                            </ul>

                            <div class="payment-method">
                                <!-- Cash on delivery -->
                                <div class="custom-control custom-checkbox mr-sm-2">
                                    <input type="checkbox" class="custom-control-input"  name="cod" id="cod" checked>
                                    <label class="custom-control-label" for="cod">Cash on Delivery</label>
                                </div>
                                <!-- Paypal -->
                                <div class="custom-control custom-checkbox mr-sm-2">
                                    <input type="checkbox" class="custom-control-input" name="paypal" id="paypal">
