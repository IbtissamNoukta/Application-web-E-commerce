...
<head>
    ...
    <!-- Title  -->
    <title>Ibtissam - MEUBLES | Home</title>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="products-catagories-area clearfix">
            ...
            try{
                ...
                $search = $_GET['search'];
                $requete1=$connexion->prepare("SELECT Id_Produit,Prix,Nom_Pr FROM Produit WHERE JSON_CONTAINS(Mot_Cle,'".json_encode($search)."')");
                $requete1->execute();
