...
<head>
    ...
    <!-- Title  -->
    <title>Ibtissam - MEUBLES | Cart</title>
                            ...
                            <table class="table table-responsive">
                                ...
                                <tbody>
                                    ...
                                    if (isset($_GET['Add'])) {
                                        ...
                                        try{
                                        $requete2=$connexion->prepare("SELECT Id_Com, Id_Produit, Nom_Pr, Qte ,prix FROM Constituer natural join Produit");
                                        $requete2->execute();
                                        ...
                                        for ($i=0; $i <count($requete2) ; $i++) { 
                                            echo(' <tr>
                                        <td class="cart_product_img">
                                            <a href="product-details.php?ID="'.$requete2[$i][1].'><img src="img/product-img/'.$requete2[$i][1].'_1.jpg" alt="Product"></a>
                                        </td>
                                        <td class="cart_product_desc">
                                            <h5>'.$requete2[$i][2].'</h5>
                                        </td>
                                        <td class="price">
                                            <span>$'.$requete2[$i][4].'</span>
                                        </td>
                                        <td class="qty">
                                            <span>'.$requete2[$i][3].'</span>
                                        </td>
                                        </tr>');
                                        $somme=$somme+$requete2[$i][4]*$requete2[$i][3];}
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="cart-summary">
                            ...
                            <ul class="summary-table">
                                <li><span>total:</span> <span>$<?php echo $somme;?></span></li>
                                <?php if(isset($_GET['Add'])){echo('<li><span>Valid Commend</span></li>');}?>
                            </ul>
                            <?php echo('<div class="cart-btn mt-100">
                               <a href="checkout.php?S='.$somme.'" class="btn amado-btn w-100">Checkout</a>
                            </div>'); ?>
                        </div>
                    </div>
                </div>
